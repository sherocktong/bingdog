...
class ConfiguredTaskUtil(object):
    ...
    def _getKeys(self):
        return ["statement", "source_file", "dist_file", "content", "bean", "write_mode", "text", "encoding", "sheet_index", "sub_task_list", "next_task", "parameters", "class_name", "mapping", "data_object", "sheet_name", "container"]
